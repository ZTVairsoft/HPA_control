...
bool batSafeFlag = false; //флаг для отключения в случае разряда аккумулятора
...
*/
  ...
  float DIV_R1 = 120.0;  //сопротивление R1 на делителе
  ...
  bool batSafe = 0; //отключение в случае разряда аккумулятора
  int zap1;
  int zap2;
  int zap3;
  bool zap4;
